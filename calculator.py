...
button_clear = tk.Button(window, text="Clear", padx=33, pady=10, command=button_clear)

# Add the number buttons to the window
...
# Add the operator buttons to the window
